...
- **NEVER guess or hallucinate URLs.** Always read URLs from CLI output. Page URLs follow: `heyiris.io/p/{slug}`
...
3. **Page URLs** are shown in CLI output — format: `heyiris.io/p/{slug}`
