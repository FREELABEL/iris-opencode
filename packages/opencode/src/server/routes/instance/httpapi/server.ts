...
import { dictateRoute, transcribeRoute } from "./transcribe"
...
import { irisHandlers } from "./handlers/iris"
...
const rootApiRoutes = HttpApiBuilder.layer(RootHttpApi).pipe(
  Layer.provide([controlHandlers, controlPlaneHandlers, globalHandlers, irisHandlers]),
...
export function createRoutes(
  ...
  return Layer.mergeAll(
    ...
    dictateRoute.pipe(Layer.provide(authOnlyRouterLayer)),
    uiRoute,
  ).pipe(
    Layer.provide([
      errorLayer,
