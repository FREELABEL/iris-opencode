export const TIPS = [
  ...
  "Use {highlight}/undo{/highlight} to revert the last message and any file changes made by IRIS CLI.",
  ...
  "Create {highlight}opencode.json{/highlight} in project root for project-specific settings (IRIS CLI uses the opencode config format).",
  "Place settings in {highlight}~/.config/opencode/opencode.json{/highlight} for global config.",
  "Run {highlight}iris hive invite{/highlight} to share your machine with another IRIS user for peer-to-peer collaboration.",
  ...
  "IRIS CLI auto-handles OAuth for remote MCP servers requiring auth.",
  ...
  "IRIS CLI auto-formats files using prettier, gofmt, ruff, and more.",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting.',
  "Define custom formatter commands with file extensions in config.",
  "IRIS CLI uses LSP servers for intelligent code analysis.",
  ...
  "Create a plugin to prevent IRIS CLI from reading sensitive files.",
  "Use {highlight}iris run{/highlight} for non-interactive scripting.",
  "Use {highlight}iris run --continue{/highlight} to resume the last session.",
  "Use {highlight}iris run -f file.ts{/highlight} to attach files via CLI.",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts.",
  "Run {highlight}iris serve{/highlight} for headless API access to IRIS CLI.",
  "Use {highlight}iris run --attach{/highlight} to connect to a running server for faster runs.",
  "Run {highlight}iris update{/highlight} to update to the latest version.",
  "Run {highlight}iris auth list{/highlight} to see all configured providers.",
  "Run {highlight}iris agent create{/highlight} for guided agent creation.",
  "Use {highlight}/iris{/highlight} in GitHub issues/PRs to trigger AI actions.",
  "Run {highlight}iris github install{/highlight} to set up the GitHub workflow.",
  "Comment {highlight}/iris fix this{/highlight} on issues to auto-create PRs.",
  ...
  "Run {highlight}iris debug config{/highlight} to troubleshoot configuration.",
  ...
  "Check {highlight}~/.iris/how-to/{/highlight} for step-by-step recipes on IRIS-specific workflows.",
  "Use {highlight}/connect{/highlight} with IRIS for curated, tested models.",
