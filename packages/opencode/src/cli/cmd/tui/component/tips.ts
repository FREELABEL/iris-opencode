export const TIPS = [
  ...
  "Use {highlight}/undo{/highlight} to revert the last message and any file changes made by IRIS Code.",
  ...
  "IRIS Code auto-handles OAuth for remote MCP servers requiring auth.",
  ...
  "IRIS Code auto-formats files using prettier, gofmt, ruff, and more.",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting.',
  "Define custom formatter commands with file extensions in config.",
  "IRIS Code uses LSP servers for intelligent code analysis.",
  ...
  "Create a plugin to prevent IRIS Code from reading sensitive files.",
  "Use {highlight}opencode run{/highlight} for non-interactive scripting.",
  "Use {highlight}opencode run --continue{/highlight} to resume the last session.",
  "Use {highlight}opencode run -f file.ts{/highlight} to attach files via CLI.",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts.",
  "Run {highlight}iris serve{/highlight} for headless API access to IRIS Code.",
