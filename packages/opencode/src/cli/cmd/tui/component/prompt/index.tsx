  ...
  return (
    <>
      ...
      <box ref={(r) => (anchor = r)} visible={props.visible !== false}>
        ...
        {/* The bottom bar is not furniture: it exists only while something is happening (a
            request in flight, a retry, shell mode). It used to render unconditionally to hold
            "tab switch agent · ctrl+p commands", which meant an always-present blank strip
            under the prompt when idle. Those two hints are in the command palette and the
            keybind config; the strip cost a line on every screen forever. */}
        <Show when={status().type !== "idle" || store.mode === "shell"}>
