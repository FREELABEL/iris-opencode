...
const TOPIC_RECIPES: Record<string, string[]> = {
  crm: [
    "Common Workflows:",
    "",
    "  # Deal pipeline — create, track, and recover deals",
    ...
    "  iris deals remind 15336                      # send next pending reminder",
    "  iris deals recover 15336                     # win-back: trigger all remaining reminders",
    "",
    "  # Multi-tier pricing (packages → proposal → Stripe)",
    "  iris leads create-package 40 -n \"Starter\" -a 250 -b monthly -f \"Feature A, Feature B\"",
    "  iris leads create-package 40 -n \"Pro\" -a 450 -b monthly -f \"Everything in Starter, Priority\"",
    "  iris deals create 15336 -a 250 -s \"Project scope\" --packages 5,6 -b 40",
    "",
