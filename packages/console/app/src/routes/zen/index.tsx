...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      <Title>OpenCode Zen | A curated set of reliable coding optimized
        models</Title>
        ...
        <div data-component="content">
          ...
          <section data-component="hero">
            <div data-component="center">
              ...
              <div data-slot="pricing-copy">
                <p><strong>Add $20 Pay as you go balance</strong> <span>(+$1.23 card processing fee)</span>
                </p>
          ...
          <section data-component="problem">
            <div data-slot="section-title">
              ...
              <p>There are so many models available, but only a few work well
                with
                coding agents.<br/>Most providers configure them differently
                with
                varying results.</p>
            </div>
            ...
            <ul>
              ...
              <li><span>[+]</span> Benchmarking all model-provider combinations
                we
                recommend
              </li>
            </ul>
          ...
          <section data-component="how">
            ...
            <ul>
              <li><span>[1]</span>
                <div><strong>Sign up and add $20 balance</strong> -
                  follow the <a
                    href=""
                    title="setup instructions">setup instructions</a></div>
              </li>
              <li><span>[2]</span>
                <div><strong>Use Zen at cost price</strong> - pay
                  per request with zero markups
                </div>
              </li>
              <li><span>[3]</span>
                <div><strong>Auto-top up</strong> - when your
            ...
            <ul>
              ...
              <li>
                <div data-slot="faq-item">
                  ...
                  <div data-slot="faq-answer" hidden>
                    ...
                    and benchmarked for coding. You wouldn’t use a butter knife
                    to cut steak, don’t use poor models for coding.
                  </div>
                </div>
              </li>
              {/*Question and answer*/}
              <li>
                <div data-slot="faq-item">
                  ...
                  <div data-slot="faq-answer" hidden>
                    OpenCode cares about balancing quality and speed in a way
                    that’s optimized for coding. We only select configurations
                    that fit that criteria. Typically high quality equates to
                    slower responses, and fast responses equates to low quality.
                    For development OpenCode believes in balance.
                  </div>
                </div>
              </li>
              {/*Question and answer*/}
              <li>
                <div data-slot="faq-item">
                  ...
                  <div data-slot="faq-answer" hidden>
                    ...
                    model providers to you. The higher Zen’s usage the more
                    OpenCode can negotiate better rates and pass those to users
                    too.
                  </div>
                </div>
              </li>
              ...
              <li>
                <div data-slot="faq-item">
                  ...
                  <div data-slot="faq-answer" hidden>
                    Zen bills per request at cost price, with zero markups.
                    Meaning what the model provider charges is exactly what you
                    pay. How much Zen costs will depend on your usage of Zen.
                    You can set monthly spend limits in your account.
                  </div>
                </div>
              </li>
              {/*Question and answer*/}
              <li>
                <div data-slot="faq-item">
                  ...
                  <div data-slot="faq-answer" hidden>
                    Zen charges per request at cost price, with zero markups.
                    Meaning what you only pay what the provider charges per
                    request. OpenCode charges a small payment processing fee of
                    $1.23 per $20 balance top-up to cover costs.
                  </div>
                </div>
              </li>
              {/*Question and answer*/}
              <li>
                <div data-slot="faq-item">
                  ...
                  <div data-slot="faq-answer" hidden>
                    We take your data and privacy seriously. All Zen models are
                    hosted in the US. Providers follow a zero-retention policy
                    and do not use your data for model training, with the
