    ...
    <main data-page="zen">
      ...
      <div data-component="content">
        ...
        <section data-component="how">
          <div data-slot="section-title">
            <h3>How Zen works</h3>
            <p>While we suggest you use Zen with OpenCode, you can use Zen with
              any agent.</p>
          </div>
          <ul>
            <li><span>[1]</span>
              ...
              follow the <a
                  href=""
                  title="setup instructions">setup instructions</a></div></li>
            <li><span>[2]</span> <div><strong>Use Zen at cost price</strong> - pay
              per request with zero markups</div>
            </li>
            <li><span>[3]</span> <div><strong>Auto-top up</strong> - when your
              balance reaches $5 we’ll automatically add $20</div>
            </li>
          </ul>
        </section>
