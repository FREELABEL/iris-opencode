export const dict = {
  ...
  "desktop.recovery.loadFailed": "IRIS gagal dimuat",
  "desktop.recovery.terminated": "Jendela IRIS berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "IRIS tidak merespons",
  ...
  "desktop.wsl.error.installIRIS": "Instalasi IRIS gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan IRIS selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh IRIS",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di IRIS.",
  ...
  "dialog.server.description": "Ganti server IRIS mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingIRIS": "Memeriksa IRIS...",
  "wsl.onboarding.checkingIRISIn": "Memeriksa IRIS di {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Memperbarui IRIS...",
  "wsl.onboarding.updatingIRISIn": "Memperbarui IRIS di {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Perbarui IRIS di {{distro}}.",
  "wsl.onboarding.updateIRIS": "Perbarui IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS siap.",
  "wsl.onboarding.installIRISIn": "Instal IRIS di {{distro}}.",
  "wsl.onboarding.installIRIS": "Instal IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum IRIS dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "IRIS tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali IRIS.",
  ...
  "help.tabs.introduction": "IRIS Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru IRIS ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim IRIS",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: IRIS belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "IRIS menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server IRIS di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk IRIS",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan IRIS di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah IRIS mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru IRIS.",
