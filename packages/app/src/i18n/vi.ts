export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu IRIS",
  ...
  "desktop.recovery.loadFailed": "Không tải được IRIS",
  "desktop.recovery.terminated": "Cửa sổ IRIS đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "IRIS không phản hồi",
  ...
  "desktop.wsl.error.installIRIS": "Không cài đặt được IRIS",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật IRIS nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do IRIS cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong IRIS.",
  ...
  "dialog.server.description": "Chuyển máy chủ IRIS mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingIRIS": "Đang kiểm tra IRIS...",
  "wsl.onboarding.checkingIRISIn": "Đang kiểm tra IRIS trong {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Đang cập nhật IRIS...",
  "wsl.onboarding.updatingIRISIn": "Đang cập nhật IRIS trong {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Cập nhật IRIS trong {{distro}}.",
  "wsl.onboarding.updateIRIS": "Cập nhật IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS đã sẵn sàng.",
  "wsl.onboarding.installIRISIn": "Cài đặt IRIS trong {{distro}}.",
  "wsl.onboarding.installIRIS": "Cài đặt IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi IRIS có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "IRIS không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại IRIS.",
  ...
  "help.tabs.introduction": "IRIS Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của IRIS ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm IRIS",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: IRIS chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "IRIS bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ IRIS bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho IRIS",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của IRIS trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem IRIS tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của IRIS.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi IRIS khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của IRIS.",
