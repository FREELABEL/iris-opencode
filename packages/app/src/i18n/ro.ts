export const dict = {
  ...
  "desktop.menu.documentation": "Documentație IRIS",
  ...
  "desktop.menu.ariaLabel": "Meniu IRIS",
  ...
  "desktop.recovery.loadFailed": "IRIS nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra IRIS s-a închis neașteptat",
  "desktop.recovery.unresponsive": "IRIS nu răspunde",
  ...
  "desktop.wsl.error.installIRIS": "Instalarea IRIS a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea IRIS s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de IRIS",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în IRIS.",
  ...
  "dialog.server.description": "Schimbă serverul IRIS la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingIRIS": "Se verifică IRIS...",
  "wsl.onboarding.checkingIRISIn": "Se verifică IRIS în {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Se actualizează IRIS...",
  "wsl.onboarding.updatingIRISIn": "Se actualizează IRIS în {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Actualizează IRIS în {{distro}}.",
  "wsl.onboarding.updateIRIS": "Actualizează IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS este gata.",
  "wsl.onboarding.installIRISIn": "Instalează IRIS în {{distro}}.",
  "wsl.onboarding.installIRIS": "Instalează IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca IRIS să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "IRIS nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide IRIS.",
  ...
  "help.tabs.introduction": "IRIS Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune IRIS ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei IRIS",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, IRIS nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "IRIS include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul IRIS în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru IRIS",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul IRIS pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă IRIS urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema IRIS.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea IRIS",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune IRIS.",
