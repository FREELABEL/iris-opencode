export const dict = {
  ...
  "desktop.menu.ariaLabel": "IRIS-meny",
  ...
  "desktop.recovery.loadFailed": "IRIS kunde inte läsas in",
  "desktop.recovery.terminated": "IRIS-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "IRIS svarar inte",
  ...
  "desktop.wsl.error.installIRIS": "Installationen av IRIS misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "IRIS-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av IRIS",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i IRIS.",
  ...
  "dialog.server.description": "Växla vilken IRIS-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingIRIS": "Kontrollerar IRIS...",
  "wsl.onboarding.checkingIRISIn": "Kontrollerar IRIS i {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Uppdaterar IRIS...",
  "wsl.onboarding.updatingIRISIn": "Uppdaterar IRIS i {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Uppdatera IRIS i {{distro}}.",
  "wsl.onboarding.updateIRIS": "Uppdatera IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS är redo.",
  "wsl.onboarding.installIRISIn": "Installera IRIS i {{distro}}.",
  "wsl.onboarding.installIRIS": "Installera IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan IRIS kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "IRIS kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan IRIS igen.",
  ...
  "help.tabs.introduction": "IRIS Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av IRIS ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till IRIS-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, IRIS stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "IRIS innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör IRIS-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för IRIS",
  ...
  "settings.general.row.appearance.description": "Anpassa hur IRIS ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om IRIS följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa IRISs tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när IRIS startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av IRIS.",
