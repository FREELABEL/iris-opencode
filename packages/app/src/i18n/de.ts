...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von IRIS",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in IRIS zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in IRIS zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in IRIS zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den IRIS-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingIRIS": "IRIS wird geprüft…",
  "wsl.onboarding.checkingIRISIn": "IRIS in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingIRIS": "IRIS wird aktualisiert…",
  "wsl.onboarding.updatingIRISIn": "IRIS in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateIRISIn": "Aktualisieren Sie IRIS in {{distro}}.",
  "wsl.onboarding.updateIRIS": "IRIS aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "IRIS ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "IRIS ist bereit.",
  "wsl.onboarding.installIRISIn": "Installieren Sie IRIS in {{distro}}.",
  "wsl.onboarding.installIRIS": "IRIS installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor IRIS einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "IRIS konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann IRIS erneut.",
  ...
  "toast.update.description": "Eine neue Version von IRIS ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem IRIS-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: IRIS unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "IRIS mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "IRIS enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "IRIS-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für IRIS ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie IRIS auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob IRIS dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von IRIS anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von IRIS automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "IRIS ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von IRIS wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "IRIS konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das IRIS-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "IRIS reagiert nicht",
  ...
  "desktop.wsl.error.installIRIS": "IRIS-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das IRIS-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "IRIS Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
