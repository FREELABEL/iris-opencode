export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi IRIS",
  ...
  "desktop.recovery.loadFailed": "IRIS gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap IRIS ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "IRIS tidak memberi respons",
  ...
  "desktop.wsl.error.installIRIS": "Pemasangan IRIS gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini IRIS selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh IRIS",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam IRIS.",
  ...
  "dialog.server.description": "Tukar pelayan IRIS yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingIRIS": "Sedang menyemak IRIS...",
  "wsl.onboarding.checkingIRISIn": "Sedang menyemak IRIS dalam {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Sedang mengemas kini IRIS...",
  "wsl.onboarding.updatingIRISIn": "Sedang mengemas kini IRIS dalam {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Kemas kini IRIS dalam {{distro}}.",
  "wsl.onboarding.updateIRIS": "Kemas kini IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS sedia digunakan.",
  "wsl.onboarding.installIRISIn": "Pasang IRIS dalam {{distro}}.",
  "wsl.onboarding.installIRIS": "Pasang IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum IRIS boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "IRIS tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula IRIS.",
  ...
  "help.tabs.introduction": "IRIS Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu IRIS ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan IRIS",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, IRIS belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "IRIS merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan IRIS dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk IRIS",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa IRIS pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada IRIS mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema IRIS.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila IRIS dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini IRIS.",
