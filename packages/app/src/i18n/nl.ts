export const dict = {
  ...
  "desktop.menu.documentation": "IRIS-documentatie",
  ...
  "desktop.recovery.loadFailed": "IRIS kan niet worden geladen",
  "desktop.recovery.terminated": "Het IRIS-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "IRIS reageert niet",
  ...
  "desktop.wsl.error.installIRIS": "Installatie van IRIS is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De IRIS-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door IRIS",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in IRIS te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in IRIS te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in IRIS te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke IRIS-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingIRIS": "IRIS controleren...",
  "wsl.onboarding.checkingIRISIn": "IRIS controleren in {{distro}}...",
  "wsl.onboarding.updatingIRIS": "IRIS bijwerken...",
  "wsl.onboarding.updatingIRISIn": "IRIS bijwerken in {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Werk IRIS bij in {{distro}}.",
  "wsl.onboarding.updateIRIS": "IRIS bijwerken",
  "wsl.onboarding.opencodeReadyIn": "IRIS is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS is klaar.",
  "wsl.onboarding.installIRISIn": "Installeer IRIS in {{distro}}.",
  "wsl.onboarding.installIRIS": "Installeer IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat IRIS een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "IRIS kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens IRIS opnieuw.",
  ...
  "help.tabs.introduction": "IRIS Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van IRIS ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het IRIS-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: IRIS ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "IRIS bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de IRIS-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor IRIS",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe IRIS eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of IRIS het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van IRIS aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer IRIS wordt gestart",
  ...
  "settings.updates.toast.latest.title": "IRIS is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van IRIS.",
