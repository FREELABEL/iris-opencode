export const dict = {
  ...
  "desktop.menu.documentation": "IRIS Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "IRIS μενού",
  ...
  "desktop.recovery.loadFailed": "IRIS απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "IRIS το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "IRIS δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installIRIS": "IRIS η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "IRIS η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από IRIS",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο IRIS.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή IRIS συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingIRIS": "Έλεγχος IRIS...",
  "wsl.onboarding.checkingIRISIn": "Έλεγχος IRIS σε {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Ενημέρωση IRIS...",
  "wsl.onboarding.updatingIRISIn": "Ενημέρωση IRIS σε {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Ενημέρωση IRIS σε {{distro}}.",
  "wsl.onboarding.updateIRIS": "Ενημέρωση IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS είναι έτοιμο.",
  "wsl.onboarding.installIRISIn": "Εγκατάσταση του IRIS στο {{distro}}.",
  "wsl.onboarding.installIRIS": "Εγκατάσταση IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο IRIS να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "IRIS δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το IRIS.",
  ...
  "help.tabs.introduction": "IRIS Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του IRIS ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα IRIS",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το IRIS δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "IRIS περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "IRIS Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή IRIS μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το IRIS",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του IRIS στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το IRIS ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το IRIS.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του IRIS",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του IRIS.",
