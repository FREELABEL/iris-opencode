export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل IRIS",
  "desktop.recovery.terminated": "توقفت نافذة IRIS بشكل غير متوقع",
  "desktop.recovery.unresponsive": "IRIS لا يستجيب",
  ...
  "desktop.wsl.error.installIRIS": "فشل تثبيت IRIS",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث IRIS، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من IRIS",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في IRIS.",
  ...
  "dialog.server.description": "تبديل خادم IRIS الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingIRIS": "جارٍ التحقق من IRIS...",
  "wsl.onboarding.checkingIRISIn": "جارٍ التحقق من IRIS في {{distro}}...",
  "wsl.onboarding.updatingIRIS": "جارٍ تحديث IRIS...",
  "wsl.onboarding.updatingIRISIn": "جارٍ تحديث IRIS في {{distro}}...",
  "wsl.onboarding.updateIRISIn": "حدّث IRIS في {{distro}}.",
  "wsl.onboarding.updateIRIS": "تحديث IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS جاهز.",
  "wsl.onboarding.installIRISIn": "ثبّت IRIS في {{distro}}.",
  "wsl.onboarding.installIRIS": "تثبيت IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن IRIS من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على IRIS التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح IRIS.",
  ...
  "help.tabs.introduction": "أصبح IRIS Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من IRIS ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق IRIS",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن IRIS لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن IRIS نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم IRIS داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ IRIS",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور IRIS على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان IRIS يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة IRIS.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل IRIS",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من IRIS.",
