...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "IRIS 載入失敗",
  "desktop.recovery.terminated": "IRIS 視窗意外終止",
  "desktop.recovery.unresponsive": "IRIS 沒有回應",
  ...
  "desktop.wsl.error.installIRIS": "IRIS 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 IRIS",
  "desktop.wsl.error.updateVersion":
    "IRIS 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "IRIS 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 IRIS 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 IRIS 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 IRIS 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 IRIS 伺服器。",
  ...
  "wsl.onboarding.checkingIRIS": "正在檢查 IRIS...",
  "wsl.onboarding.checkingIRISIn": "正在檢查 {{distro}} 中的 IRIS...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 IRIS 已就緒。",
  "wsl.onboarding.opencodeReady": "IRIS 已就緒。",
  "wsl.onboarding.installIRISIn": "在 {{distro}} 中安裝 IRIS。",
  "wsl.onboarding.installIRIS": "安裝 IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 IRIS",
  ...
  "wsl.onboarding.wslUnavailable.description": "IRIS 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 IRIS。",
  ...
  "help.tabs.introduction": "IRIS Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "IRIS 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 IRIS 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：IRIS 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "IRIS 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 IRIS 伺服器。",
  ...
  "settings.general.row.language.description": "變更 IRIS 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 IRIS 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 IRIS 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 IRIS 的主題。",
  ...
  "settings.updates.row.startup.description": "在 IRIS 啟動時自動檢查更新",
