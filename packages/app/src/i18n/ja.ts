export const dict = {
  ...
  "desktop.recovery.loadFailed": "IRISを読み込めませんでした",
  "desktop.recovery.terminated": "IRISのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "IRISが応答していません",
  ...
  "desktop.wsl.error.installIRIS": "IRISのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはIRISがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "IRISのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "IRISが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、IRISで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してIRISで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、IRISで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するIRISサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingIRIS": "IRISを確認中...",
  "wsl.onboarding.checkingIRISIn": "{{distro}}内のIRISを確認中...",
  "wsl.onboarding.updatingIRIS": "IRISを更新中...",
  "wsl.onboarding.updatingIRISIn": "{{distro}}内のIRISを更新中...",
  "wsl.onboarding.updateIRISIn": "{{distro}}内のIRISを更新してください。",
  "wsl.onboarding.updateIRIS": "IRISを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のIRISの準備ができました。",
  "wsl.onboarding.opencodeReady": "IRISの準備ができました。",
  "wsl.onboarding.installIRISIn": "{{distro}}にIRISをインストールしてください。",
  "wsl.onboarding.installIRIS": "IRISをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRISがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "IRISでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、IRISをもう一度開いてください。",
  ...
  "help.tabs.introduction": "IRIS Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "IRISの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをIRISチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: IRISはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "IRISには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でIRISサーバーを実行します。",
  ...
  "settings.general.row.language.description": "IRISの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのIRISの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "IRISがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "IRISのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "IRIS の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "IRIS は最新バージョンです。",
