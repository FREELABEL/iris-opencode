export const dict = {
  ...
  "desktop.menu.documentation": "IRIS Skjøl",
  ...
  "desktop.menu.ariaLabel": "IRIS valmynd",
  ...
  "desktop.recovery.loadFailed": "IRIS miseydnaðist at heinta",
  "desktop.recovery.terminated": "IRIS vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "IRIS svarar ikki",
  ...
  "desktop.wsl.error.installIRIS": "IRIS uppsetingin miseydnaðist",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "IRIS dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av IRIS",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í IRIS.",
  ...
  "dialog.server.description": "Skift hvønn IRIS ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingIRIS": "Kanna IRIS...",
  "wsl.onboarding.checkingIRISIn": "Kanna IRIS í {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Dagføring IRIS...",
  "wsl.onboarding.updatingIRISIn": "Dagføring IRIS í {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Dagfør IRIS í {{distro}}.",
  "wsl.onboarding.updateIRIS": "Dagfør IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS er klárt í {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS er klárt.",
  "wsl.onboarding.installIRISIn": "Set IRIS upp í {{distro}}.",
  "wsl.onboarding.installIRIS": "Set upp IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn IRIS kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "IRIS kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani IRIS aftur.",
  ...
  "help.tabs.introduction": "IRIS Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av IRIS ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til IRIS toymið",
  ...
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, IRIS stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "IRIS inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "IRIS Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr IRIS ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri IRIS",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu IRIS sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um IRIS fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu IRIS er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá IRIS byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av IRIS.",
