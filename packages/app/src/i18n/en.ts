...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by IRIS",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in IRIS.",
  ...
  "wsl.onboarding.checkingIRIS": "Checking IRIS...",
  "wsl.onboarding.checkingIRISIn": "Checking IRIS in {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Updating IRIS...",
  "wsl.onboarding.updatingIRISIn": "Updating IRIS in {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Update IRIS in {{distro}}.",
  "wsl.onboarding.updateIRIS": "Update IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS is ready.",
  "wsl.onboarding.installIRISIn": "Install IRIS in {{distro}}.",
  "wsl.onboarding.installIRIS": "Install IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before IRIS can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "IRIS could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen IRIS.",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, IRIS does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "IRIS includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for IRIS",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how IRIS looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether IRIS follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how IRIS is themed.",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of IRIS.",
