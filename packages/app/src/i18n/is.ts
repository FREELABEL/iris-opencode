...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða IRIS",
  "IRIS-glugganum var óvænt lokað",
  "IRIS svarar ekki",
  ...
  "IRIS er ekki uppsett í {{distro}}",
  "Uppfærslu IRIS lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá IRIS",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í IRIS.",
  ...
  "dialog.server.description": "Skiptu um hvaða IRIS miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingIRIS": "Athugar IRIS...",
  "wsl.onboarding.checkingIRISIn": "Athugar IRIS í {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Uppfærir IRIS...",
  "wsl.onboarding.updatingIRISIn": "Uppfærir IRIS í {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Uppfærðu IRIS í {{distro}}.",
  "wsl.onboarding.updateIRIS": "Uppfærðu IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS er tilbúinn.",
  "wsl.onboarding.installIRISIn": "Settu upp IRIS í {{distro}}.",
  "wsl.onboarding.installIRIS": "Settu upp IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en IRIS getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "IRIS gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan IRIS aftur.",
  ...
  "help.tabs.introduction": "IRIS Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af IRIS ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til IRIS teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, IRIS styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "IRIS inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "IRIS skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu IRIS netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir IRIS",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig IRIS lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort IRIS fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig IRIS er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar IRIS ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af IRIS.",
