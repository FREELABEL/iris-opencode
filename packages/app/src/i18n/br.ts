export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do IRIS",
  ...
  "desktop.menu.ariaLabel": "Menu do IRIS",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o IRIS",
  "desktop.recovery.terminated": "A janela do IRIS foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O IRIS não está respondendo",
  ...
  "desktop.wsl.error.installIRIS": "Falha na instalação do IRIS",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O IRIS não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do IRIS foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo IRIS",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no IRIS.",
  ...
  "dialog.server.description": "Trocar para qual servidor IRIS este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingIRIS": "Verificando o IRIS...",
  "wsl.onboarding.checkingIRISIn": "Verificando o IRIS em {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Atualizando o IRIS...",
  "wsl.onboarding.updatingIRISIn": "Atualizando o IRIS em {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Atualize o IRIS em {{distro}}.",
  "wsl.onboarding.updateIRIS": "Atualizar o IRIS",
  "wsl.onboarding.opencodeReadyIn": "O IRIS está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O IRIS está pronto.",
  "wsl.onboarding.installIRISIn": "Instale o IRIS em {{distro}}.",
  "wsl.onboarding.installIRIS": "Instalar o IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o IRIS possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O IRIS não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o IRIS novamente.",
  ...
  "help.tabs.introduction": "Agora, o IRIS Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do IRIS ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do IRIS",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: IRIS ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "IRIS inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor IRIS dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do IRIS",
  ...
  "settings.general.row.appearance.description": "Personalize como o IRIS aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o IRIS segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o IRIS é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o IRIS iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do IRIS.",
