export const dict = {
  ...
  "desktop.menu.documentation": "IRIS دستاویزات",
  ...
  "desktop.menu.ariaLabel": "IRIS مینو",
  ...
  "desktop.recovery.loadFailed": "IRIS لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "IRIS ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "IRIS جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installIRIS": "IRIS کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں IRIS انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "IRIS کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "IRIS کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور IRIS میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور IRIS میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور IRIS میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس IRIS سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingIRIS": "IRIS چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingIRISIn": "{{distro}} میں IRIS چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingIRIS": "IRIS کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingIRISIn": "{{distro}} میں IRIS کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateIRISIn": "{{distro}} میں IRIS کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateIRIS": "IRIS کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "IRIS {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "IRIS تیار ہے۔",
  "wsl.onboarding.installIRISIn": "{{distro}} میں IRIS انسٹال کریں۔",
  "wsl.onboarding.installIRIS": "IRIS انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ IRIS WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "IRIS اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر IRIS کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "IRIS Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "IRIS ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم IRIS ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، IRIS ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "IRIS میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "IRIS ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر IRIS سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "IRIS کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر IRIS کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا IRIS سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "IRIS کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "IRIS لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ IRIS کا تازہ ترین ورژن چلا رہے ہیں۔",
