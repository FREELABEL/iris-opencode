export const dict = {
  ...
  "desktop.recovery.loadFailed": "IRIS laadimine ebaõnnestus",
  "desktop.recovery.terminated": "IRIS aken suleti ootamatult",
  "desktop.recovery.unresponsive": "IRIS ei vasta",
  ...
  "desktop.wsl.error.installIRIS": "IRIS installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "IRIS värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub IRIS",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid IRIS'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises IRIS.",
  ...
  "dialog.server.description": "Lülitage, millise IRIS serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingIRIS": "IRIS kontrollimine...",
  "wsl.onboarding.checkingIRISIn": "IRIS kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingIRIS": "IRIS värskendamine...",
  "wsl.onboarding.updatingIRISIn": "IRIS värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Värskenda IRIS jaotises {{distro}}.",
  "wsl.onboarding.updateIRIS": "Värskenda IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS on valmis.",
  "wsl.onboarding.installIRISIn": "Installige IRIS asukohta {{distro}}.",
  "wsl.onboarding.installIRIS": "Installige IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui IRIS saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "IRIS ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti IRIS.",
  ...
  "help.tabs.introduction": "IRIS Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse IRIS ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast IRIS meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, IRIS ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "IRIS sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "settings.desktop.wsl.description": "Käivitage IRIS server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke IRIS kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas IRIS teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas IRIS järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas IRIS on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui IRIS käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse IRIS uusimat versiooni.",
