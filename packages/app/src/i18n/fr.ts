export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'IRIS",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'IRIS",
  "desktop.recovery.terminated": "La fenêtre IRIS s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "IRIS ne répond pas",
  ...
  "desktop.wsl.error.installIRIS": "Échec de l'installation d'IRIS",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'IRIS est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par IRIS",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans IRIS.",
  ...
  "dialog.server.description": "Changez le serveur IRIS auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingIRIS": "Vérification d'IRIS...",
  "wsl.onboarding.checkingIRISIn": "Vérification d'IRIS dans {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Mise à jour d'IRIS...",
  "wsl.onboarding.updatingIRISIn": "Mise à jour d'IRIS dans {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Mettez à jour IRIS dans {{distro}}.",
  "wsl.onboarding.updateIRIS": "Mettre à jour IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS est prêt.",
  "wsl.onboarding.installIRISIn": "Installez IRIS dans {{distro}}.",
  "wsl.onboarding.installIRIS": "Installer IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'IRIS puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "IRIS n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez IRIS.",
  ...
  "help.tabs.introduction": "IRIS Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'IRIS ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe IRIS",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'IRIS ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "IRIS inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur IRIS dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour IRIS",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'IRIS sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si IRIS suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'IRIS.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'IRIS",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'IRIS.",
