export const dict = {
  ...
  "desktop.menu.documentation": "IRIS hujjatlari",
  ...
  "desktop.menu.ariaLabel": "IRIS menyusi",
  ...
  "desktop.recovery.loadFailed": "IRIS yuklanmadi",
  "desktop.recovery.terminated": "IRIS oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "IRIS javob bermayapti",
  ...
  "desktop.wsl.error.installIRIS": "IRIS oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.opencodeMissing": "IRIS ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.opencodeCannotRun": "opencode o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.opencodeNotInstalled": "IRIS {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "IRIS yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "IRIS tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va IRIS’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va IRIS da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va IRIS da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi IRIS serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingIRIS": "IRIS tekshirilmoqda...",
  "wsl.onboarding.checkingIRISIn": "IRIS {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingIRIS": "IRIS yangilanmoqda...",
  "wsl.onboarding.updatingIRISIn": "IRIS {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateIRISIn": "IRIS-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateIRIS": "IRIS-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "IRIS {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "IRIS tayyor.",
  "wsl.onboarding.installIRISIn": "IRIS-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installIRIS": "IRIS-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "IRIS WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "IRIS WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra IRIS-ni qayta oching.",
  ...
  "help.tabs.introduction": "IRIS Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "IRIS ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida IRIS jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, IRIS hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "IRIS bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi IRIS serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "IRIS uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "IRIS qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "IRIS tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "IRIS mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "IRIS ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz IRIS oxirgi versiyasini ishga tushiryapsiz.",
