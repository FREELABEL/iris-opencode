export const dict = {
  ...
  "desktop.recovery.loadFailed": "IRIS yüklənə bilmədi",
  "desktop.recovery.terminated": "IRIS pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "IRIS cavab vermir",
  ...
  "desktop.wsl.error.installIRIS": "IRIS quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "IRIS yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "IRIS tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və IRIS-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və IRIS-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və IRIS-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu IRIS serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingIRIS": "IRIS yoxlanılır...",
  "wsl.onboarding.checkingIRISIn": "{{distro}}-də IRIS yoxlanılır...",
  "wsl.onboarding.updatingIRIS": "IRIS yenilənir...",
  "wsl.onboarding.updatingIRISIn": "{{distro}}-də IRIS yenilənir...",
  "wsl.onboarding.updateIRISIn": "{{distro}}-də IRIS-u yeniləyin.",
  "wsl.onboarding.updateIRIS": "IRIS-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "IRIS {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "IRIS hazırdır.",
  "wsl.onboarding.installIRISIn": "IRIS-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installIRIS": "IRIS quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "IRIS WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "IRIS bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra IRIS-u yenidən açın.",
  ...
  "help.tabs.introduction": "IRIS Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "IRIS-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı IRIS komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: IRIS hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "IRIS-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində IRIS serverini işlət.",
  ...
  "settings.general.row.language.description": "IRIS üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "IRIS-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "IRIS-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "IRIS-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "IRIS açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "IRIS-un ən son versiyasından istifadə edirsiniz.",
