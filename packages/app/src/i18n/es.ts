export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de IRIS",
  ...
  "desktop.menu.ariaLabel": "Menú de IRIS",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar IRIS",
  "desktop.recovery.terminated": "La ventana de IRIS se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "IRIS no responde",
  ...
  "desktop.wsl.error.installIRIS": "No se pudo instalar IRIS",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de IRIS finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por IRIS",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en IRIS.",
  ...
  "dialog.server.description": "Cambiar el servidor de IRIS al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingIRIS": "Comprobando IRIS...",
  "wsl.onboarding.checkingIRISIn": "Comprobando IRIS en {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Actualizando IRIS...",
  "wsl.onboarding.updatingIRISIn": "Actualizando IRIS en {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Actualiza IRIS en {{distro}}.",
  "wsl.onboarding.updateIRIS": "Actualizar IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS está listo.",
  "wsl.onboarding.installIRISIn": "Instala IRIS en {{distro}}.",
  "wsl.onboarding.installIRIS": "Instalar IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que IRIS pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "IRIS no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir IRIS.",
  ...
  "help.tabs.introduction": "IRIS Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de IRIS ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de IRIS",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: IRIS aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "IRIS incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor IRIS dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para IRIS",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve IRIS en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si IRIS sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de IRIS.",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de IRIS.",
