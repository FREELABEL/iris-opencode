export const dict = {
  ...
  "desktop.menu.documentation": "IRIS Documentació",
  ...
  "desktop.menu.ariaLabel": "menú IRIS.",
  ...
  "desktop.recovery.loadFailed": "IRIS no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra IRIS s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "IRIS no respon",
  ...
  "desktop.wsl.error.installIRIS": "La instal·lació de IRIS ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "IRIS actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per IRIS",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a IRIS.",
  ...
  "dialog.server.description": "Canvia a quin IRIS servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingIRIS": "S'està comprovant IRIS...",
  "wsl.onboarding.checkingIRISIn": "S'està registrant IRIS a {{distro}}...",
  "wsl.onboarding.updatingIRIS": "S'està actualitzant IRIS...",
  "wsl.onboarding.updatingIRISIn": "S'està actualitzant IRIS a {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Actualitza IRIS a {{distro}}.",
  "wsl.onboarding.updateIRIS": "Actualització IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS està llest.",
  "wsl.onboarding.installIRISIn": "Instal·leu IRIS a {{distro}}.",
  "wsl.onboarding.installIRIS": "Instal·la IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que IRIS pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "IRIS no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir IRIS.",
  ...
  "help.tabs.introduction": "IRIS L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de IRIS ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip IRIS.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que IRIS encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "IRIS inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "IRIS Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor IRIS dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a IRIS",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu IRIS al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si IRIS segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de IRIS.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï IRIS.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de IRIS.",
