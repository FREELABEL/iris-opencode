export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja IRIS",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać IRIS",
  "desktop.recovery.terminated": "Okno IRIS zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "IRIS nie odpowiada",
  ...
  "desktop.wsl.error.installIRIS": "Nie udało się zainstalować IRIS",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja IRIS została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez IRIS",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w IRIS.",
  ...
  "dialog.server.description": "Przełącz serwer IRIS, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingIRIS": "Sprawdzanie IRIS...",
  "wsl.onboarding.checkingIRISIn": "Sprawdzanie IRIS w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Aktualizowanie IRIS...",
  "wsl.onboarding.updatingIRISIn": "Aktualizowanie IRIS w dystrybucji {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Zaktualizuj IRIS w dystrybucji {{distro}}.",
  "wsl.onboarding.updateIRIS": "Zaktualizuj IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS jest gotowy.",
  "wsl.onboarding.installIRISIn": "Zainstaluj IRIS w dystrybucji {{distro}}.",
  "wsl.onboarding.installIRIS": "Zainstaluj IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim IRIS będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "IRIS nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz IRIS.",
  ...
  "help.tabs.introduction": "IRIS Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja IRIS ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu IRIS",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: IRIS nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "IRIS zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer IRIS wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla IRIS",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd IRIS na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy IRIS ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw IRIS.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania IRIS",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji IRIS.",
