export const dict = {
  ...
  "desktop.menu.documentation": "IRIS Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka IRIS",
  ...
  "desktop.recovery.loadFailed": "IRIS se nepodařilo načíst",
  "desktop.recovery.terminated": "IRIS okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "IRIS nereaguje",
  ...
  "desktop.wsl.error.installIRIS": "IRIS instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "IRIS aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v IRIS.",
  ...
  "dialog.server.description": "Přepněte, ke kterému IRIS serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingIRIS": "Kontrola IRIS...",
  "wsl.onboarding.checkingIRISIn": "Kontrola IRIS v {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Aktualizace IRIS...",
  "wsl.onboarding.updatingIRISIn": "Aktualizace IRIS v {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Aktualizace IRIS v {{distro}}.",
  "wsl.onboarding.updateIRIS": "Aktualizovat IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS je připraven.",
  "wsl.onboarding.installIRISIn": "Nainstalujte IRIS do {{distro}}.",
  "wsl.onboarding.installIRIS": "Instalovat IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než IRIS může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "IRIS nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete IRIS.",
  ...
  "help.tabs.introduction": "IRIS Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze IRIS ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu IRIS",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: IRIS zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "IRIS obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server IRIS uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro IRIS",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled IRIS na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude IRIS následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma IRIS.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění IRIS",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi IRIS.",
