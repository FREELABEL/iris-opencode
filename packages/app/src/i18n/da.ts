export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af IRIS",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i IRIS.",
  ...
  "dialog.server.description": "Skift hvilken IRIS-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingIRIS": "Tjekker IRIS...",
  "wsl.onboarding.checkingIRISIn": "Tjekker IRIS i {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Opdaterer IRIS...",
  "wsl.onboarding.updatingIRISIn": "Opdaterer IRIS i {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Opdater IRIS i {{distro}}.",
  "wsl.onboarding.updateIRIS": "Opdater IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før IRIS kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "IRIS kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter IRIS igen.",
  ...
  "toast.update.description": "En ny version af IRIS ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til IRIS-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, IRIS understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "IRIS inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør IRIS-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for IRIS",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan IRIS ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om IRIS skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas IRISs tema.",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af IRIS.",
  ...
  "desktop.recovery.loadFailed": "IRIS kunne ikke indlæses",
  "desktop.recovery.terminated": "IRIS-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installIRIS": "Installationen af IRIS mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af IRIS er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "IRIS Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
