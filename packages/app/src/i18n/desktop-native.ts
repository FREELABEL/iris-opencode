...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "IRIS failed to load",
  "desktop.recovery.terminated": "IRIS window terminated unexpectedly",
  "desktop.recovery.unresponsive": "IRIS is not responding",
  ...
  "desktop.wsl.error.installIRIS": "IRIS installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "IRIS update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
