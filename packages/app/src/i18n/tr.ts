...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "IRIS yüklenemedi",
  "desktop.recovery.terminated": "IRIS penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "IRIS yanıt vermiyor",
  ...
  "desktop.wsl.error.installIRIS": "IRIS kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "IRIS güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "IRIS tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve IRIS'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak IRIS'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak IRIS'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi IRIS sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingIRIS": "IRIS kontrol ediliyor...",
  "wsl.onboarding.checkingIRISIn": "{{distro}} içinde IRIS kontrol ediliyor...",
  "wsl.onboarding.updatingIRIS": "IRIS güncelleniyor...",
  "wsl.onboarding.updatingIRISIn": "{{distro}} içinde IRIS güncelleniyor...",
  "wsl.onboarding.updateIRISIn": "{{distro}} içindeki IRIS'u güncelleyin.",
  "wsl.onboarding.updateIRIS": "IRIS'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde IRIS hazır.",
  "wsl.onboarding.opencodeReady": "IRIS hazır.",
  "wsl.onboarding.installIRISIn": "IRIS'u {{distro}} içine kurun.",
  "wsl.onboarding.installIRIS": "IRIS'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "IRIS'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "IRIS bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından IRIS'u tekrar açın.",
  ...
  "help.tabs.introduction": "IRIS Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "IRIS'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı IRIS ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: IRIS henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "IRIS ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "IRIS Masaüstü",
  ...
  "settings.desktop.wsl.description": "IRIS sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "IRIS'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "IRIS'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "IRIS'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "IRIS'un temasını özelleştirin.",
  ...
  "settings.updates.toast.latest.description": "IRIS'un en son sürümünü kullanıyorsunuz.",
