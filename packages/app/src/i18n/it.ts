export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da IRIS",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in IRIS.",
  ...
  "dialog.server.description": "Cambia il server IRIS a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingIRIS": "Controllo IRIS...",
  "wsl.onboarding.checkingIRISIn": "Controllo IRIS in {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Aggiornamento IRIS...",
  "wsl.onboarding.updatingIRISIn": "Aggiornamento IRIS in {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Aggiorna IRIS in {{distro}}.",
  "wsl.onboarding.updateIRIS": "Aggiorna IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS è pronto.",
  "wsl.onboarding.installIRISIn": "Installa IRIS in {{distro}}.",
  "wsl.onboarding.installIRIS": "Installa IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che IRIS possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "IRIS non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri IRIS.",
  ...
  "help.tabs.introduction": "IRIS Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di IRIS ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team IRIS",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: IRIS non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "IRIS include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server IRIS all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per IRIS",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di IRIS sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se IRIS segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di IRIS.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di IRIS",
  ...
  "settings.updates.toast.latest.title": "IRIS è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di IRIS.",
  ...
  "desktop.menu.documentation": "Documentazione di IRIS",
  ...
  "desktop.menu.ariaLabel": "Menu IRIS",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare IRIS",
  "desktop.recovery.terminated": "La finestra di IRIS si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "IRIS non risponde",
  ...
  "desktop.wsl.error.installIRIS": "Installazione di IRIS non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di IRIS è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
