...
export const dict = {
  ...
  "desktop.menu.documentation": "IRIS-dokumentasjon",
  ...
  "desktop.recovery.loadFailed": "IRIS kunne ikke lastes inn",
  "desktop.recovery.terminated": "IRIS-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "IRIS svarer ikke",
  ...
  "desktop.wsl.error.installIRIS": "Installasjonen av IRIS mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av IRIS er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av IRIS",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i IRIS.",
  ...
  "dialog.server.description": "Bytt hvilken IRIS-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av IRIS ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til IRIS-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at IRIS ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "IRIS inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør IRIS-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for IRIS",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan IRIS ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om IRIS skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i IRIS.",
  ...
  "settings.updates.toast.latest.title": "IRIS er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av IRIS.",
  ...
  "wsl.onboarding.checkingIRIS": "Sjekker IRIS...",
  "wsl.onboarding.checkingIRISIn": "Sjekker IRIS i {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Oppdaterer IRIS...",
  "wsl.onboarding.updatingIRISIn": "Oppdaterer IRIS i {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Oppdater IRIS i {{distro}}.",
  "wsl.onboarding.updateIRIS": "Oppdater IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS er klar.",
  "wsl.onboarding.installIRISIn": "Installer IRIS i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før IRIS kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "IRIS kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter IRIS på nytt.",
  ...
  "help.tabs.introduction": "IRIS Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
