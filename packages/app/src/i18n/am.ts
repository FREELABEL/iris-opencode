export const dict = {
  ...
  "desktop.recovery.loadFailed": "IRIS መጫን አልቻለም",
  "desktop.recovery.terminated": "IRIS መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "IRIS ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installIRIS": "IRISመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "IRIS ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በIRIS",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በIRIS ይጠቀሙ።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በIRIS ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በIRIS ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው IRIS አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingIRIS": "መፈተሽ IRIS...",
  "wsl.onboarding.checkingIRISIn": "IRISን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingIRIS": "በማዘመን ላይ IRIS...",
  "wsl.onboarding.updatingIRISIn": "በማዘመን ላይ IRIS በ{{distro}}...",
  "wsl.onboarding.updateIRISIn": "አዘምን IRIS በ{{distro}}።",
  "wsl.onboarding.updateIRIS": "አዘምን IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "IRIS ዝግጁ ነው።",
  "wsl.onboarding.installIRISIn": "መጫን IRIS በ{{distro}} ውስጥ።",
  "wsl.onboarding.installIRIS": "ጫን IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRISአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) IRIS WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "IRIS በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ IRIS።",
  ...
  "help.tabs.introduction": "IRIS ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የIRIS ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለIRIS ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ IRIS እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "IRIS ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "settings.desktop.wsl.description": "የIRIS አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለIRIS",
  ...
  "settings.general.row.appearance.description": "IRISበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "IRIS ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "IRIS ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "IRIS ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የIRIS እትም እያሄዱ ነው።",
