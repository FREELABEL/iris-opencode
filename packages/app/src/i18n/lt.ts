...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "IRIS įkelti nepavyko",
  "IRIS langas netikėtai užsidarė",
  "IRIS neatsako",
  ...
  "IRIS įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "IRIS neįdiegtas distributyve {{distro}}",
  "IRIS naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami IRIS modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius IRIS.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio IRIS serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingIRIS": "Tikrinama IRIS...",
  "wsl.onboarding.checkingIRISIn": "Tikrinama IRIS {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Atnaujinamas IRIS...",
  "wsl.onboarding.updatingIRISIn": "Atnaujinamas IRIS {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Atnaujinkite IRIS {{distro}}.",
  "wsl.onboarding.updateIRIS": "Atnaujinkite IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS yra paruoštas.",
  "wsl.onboarding.installIRISIn": "Įdiekite IRIS į {{distro}}.",
  "wsl.onboarding.installIRIS": "Įdiekite IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad IRIS galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "IRIS nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite IRIS.",
  ...
  "help.tabs.introduction": "IRIS Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują IRIS ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą IRIS komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad IRIS dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "IRIS apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "IRIS darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite IRIS serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite IRIS ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip IRIS atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar IRIS seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite IRIS temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas IRIS",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią IRIS versiją.",
