export const dict = {
  ...
  "desktop.menu.documentation": "Документація IRIS",
  ...
  "desktop.menu.ariaLabel": "Меню IRIS",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити IRIS",
  "desktop.recovery.terminated": "Роботу вікна IRIS несподівано завершено",
  "desktop.recovery.unresponsive": "IRIS не відповідає",
  ...
  "desktop.wsl.error.installIRIS": "Не вдалося встановити IRIS",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення IRIS завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від IRIS",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у IRIS.",
  ...
  "dialog.server.description": "Перемкніть сервер IRIS, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingIRIS": "Перевірка IRIS...",
  "wsl.onboarding.checkingIRISIn": "Перевірка IRIS у {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Оновлення IRIS...",
  "wsl.onboarding.updatingIRISIn": "Оновлення IRIS у {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Оновіть IRIS у {{distro}}.",
  "wsl.onboarding.updateIRIS": "Оновити IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS готовий до роботи.",
  "wsl.onboarding.installIRISIn": "Встановіть IRIS у {{distro}}.",
  "wsl.onboarding.installIRIS": "Встановити IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в IRIS потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "IRIS не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте IRIS.",
  ...
  "help.tabs.introduction": "IRIS Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія IRIS ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді IRIS",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, IRIS ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "IRIS містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер IRIS всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу IRIS",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд IRIS на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи IRIS використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему IRIS.",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію IRIS.",
