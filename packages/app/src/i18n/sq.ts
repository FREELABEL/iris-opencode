export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni IRIS",
  ...
  "desktop.menu.ariaLabel": "Menuja IRIS",
  ...
  "desktop.recovery.loadFailed": "IRIS nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja IRIS u mbyll papritur",
  "desktop.recovery.unresponsive": "IRIS nuk po përgjigjet",
  ...
  "desktop.wsl.error.installIRIS": "Instalimi i IRIS dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.opencodeMissing": "IRIS nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.opencodeCannotRun": "IRIS është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.opencodeNotInstalled": "IRIS nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i IRIS përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga IRIS",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në IRIS.",
  ...
  "dialog.server.description": "Ndrysho me cilin server IRIS lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingIRIS": "Po kontrollon IRIS...",
  "wsl.onboarding.checkingIRISIn": "Po kontrollon IRIS në {{distro}}...",
  "wsl.onboarding.updatingIRIS": "IRIS po përditësohet...",
  "wsl.onboarding.updatingIRISIn": "Po përditëson IRIS në {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Përditëso IRIS në {{distro}}.",
  "wsl.onboarding.updateIRIS": "Përditëso IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS është gati në {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS është gati.",
  "wsl.onboarding.installIRISIn": "Instaloni IRIS në {{distro}}.",
  "wsl.onboarding.installIRIS": "Instaloni IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se IRIS të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "IRIS nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap IRIS.",
  ...
  "help.tabs.introduction": "IRIS Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i IRIS ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i IRIS",
  ...
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, IRIS nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "IRIS përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin IRIS brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për IRIS",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket IRIS në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse IRIS ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e IRIS.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset IRIS",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të IRIS.",
