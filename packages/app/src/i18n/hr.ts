...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "IRIS se nije uspio učitati",
  "Prozor aplikacije IRIS neočekivano je zatvoren",
  "IRIS ne reagira",
  ...
  "Instalacija aplikacije IRIS nije uspjela",
  ...
  "IRIS nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije IRIS je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi IRIS",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u IRIS.",
  ...
  "dialog.server.description": "Promijenite na koji se IRIS poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingIRISIn": "Provjera IRIS u {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Ažuriranje IRIS...",
  "wsl.onboarding.updatingIRISIn": "Ažuriranje IRIS u {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Ažurirajte IRIS u {{distro}}.",
  "wsl.onboarding.updateIRIS": "Ažurirajte IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS je spreman.",
  "wsl.onboarding.installIRISIn": "Instalirajte IRIS u {{distro}}.",
  "wsl.onboarding.installIRIS": "Instalirajte IRIS",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što IRIS može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "IRIS nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite IRIS.",
  ...
  "help.tabs.introduction": "Radna površina IRIS sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija IRIS ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku IRIS timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, IRIS još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "IRIS uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "IRIS Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite IRIS poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za IRIS",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako IRIS izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li IRIS slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je IRIS tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se IRIS pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju IRIS.",
