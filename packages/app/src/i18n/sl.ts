export const dict = {
  ...
  "desktop.menu.documentation": "IRIS Dokumentacija",
  ...
  "desktop.menu.ariaLabel": "IRIS meni",
  ...
  "desktop.recovery.loadFailed": "IRIS ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno IRIS se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "IRIS se ne odziva",
  ...
  "desktop.wsl.error.installIRIS": "Namestitev IRIS ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev IRIS je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja IRIS",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v IRIS.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom IRIS se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingIRIS": "Preverjanje IRIS ...",
  "wsl.onboarding.checkingIRISIn": "Preverjanje IRIS v {{distro}} ...",
  "wsl.onboarding.updatingIRIS": "Posodabljanje IRIS ...",
  "wsl.onboarding.updatingIRISIn": "Posodabljanje IRIS v {{distro}} ...",
  "wsl.onboarding.updateIRISIn": "Posodobite IRIS v {{distro}}.",
  "wsl.onboarding.updateIRIS": "Posodobite IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS je pripravljen.",
  "wsl.onboarding.installIRISIn": "Namestite IRIS v {{distro}}.",
  "wsl.onboarding.installIRIS": "Namestite IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko IRIS doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "IRIS ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite IRIS.",
  ...
  "help.tabs.introduction": "IRIS Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica IRIS ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi IRIS",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, IRIS še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "IRIS vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik IRIS znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za IRIS",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako IRIS izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali IRIS sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo IRIS.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene IRIS",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico IRIS.",
