export const dict = {
  ...
  "desktop.menu.documentation": "Документация IRIS",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить IRIS",
  "desktop.recovery.terminated": "Окно IRIS неожиданно завершило работу",
  "desktop.recovery.unresponsive": "IRIS не отвечает",
  ...
  "desktop.wsl.error.installIRIS": "Не удалось установить IRIS",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление IRIS завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от IRIS",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в IRIS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в IRIS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в IRIS.",
  ...
  "dialog.server.description": "Выберите сервер IRIS, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingIRIS": "Проверка IRIS...",
  "wsl.onboarding.checkingIRISIn": "Проверка IRIS в {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Обновление IRIS...",
  "wsl.onboarding.updatingIRISIn": "Обновление IRIS в {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Обновите IRIS в {{distro}}.",
  "wsl.onboarding.updateIRIS": "Обновить IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "IRIS готов к работе.",
  "wsl.onboarding.installIRISIn": "Установите IRIS в {{distro}}.",
  "wsl.onboarding.installIRIS": "Установить IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в IRIS требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "IRIS не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте IRIS.",
  ...
  "help.tabs.introduction": "Теперь работа в IRIS Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия IRIS ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде IRIS",
  ...
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: IRIS пока не поддерживает MCP-авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "IRIS включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер IRIS внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения IRIS",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид IRIS на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли IRIS системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление IRIS.",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию IRIS.",
