export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za IRIS",
  ...
  "desktop.recovery.loadFailed": "IRIS se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor IRIS-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "IRIS ne reaguje",
  ...
  "desktop.wsl.error.installIRIS": "Instalacija IRIS-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRIS nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje IRIS-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje IRIS",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u IRIS-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u IRIS-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u IRIS-u.",
  ...
  "dialog.server.description": "Promijeni na koji se IRIS server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingIRIS": "Provjera IRIS...",
  "wsl.onboarding.checkingIRISIn": "Provjera IRIS u distribuciji {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Ažuriranje IRIS...",
  "wsl.onboarding.updatingIRISIn": "Ažuriranje IRIS u distribuciji {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Ažuriraj IRIS u distribuciji {{distro}}.",
  "wsl.onboarding.updateIRIS": "Ažuriraj IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS je spreman.",
  "wsl.onboarding.installIRISIn": "Instaliraj IRIS u distribuciji {{distro}}.",
  "wsl.onboarding.installIRIS": "Instaliraj IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRIS nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi IRIS mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "IRIS nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori IRIS.",
  ...
  "help.tabs.introduction": "IRIS Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija IRIS-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku IRIS timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: IRIS još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "IRIS uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni IRIS server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u IRIS-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako IRIS izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li IRIS prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu IRIS-a.",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju IRIS-a.",
