export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "IRISn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja IRISssa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja IRISssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja IRISssa.",
  ...
  "dialog.server.description": "Vaihda IRIS-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingIRIS": "Tarkistetaan IRISa...",
  "wsl.onboarding.checkingIRISIn": "Tarkistetaan IRISa kohteessa {{distro}}...",
  "wsl.onboarding.updatingIRIS": "Päivitetään IRISa...",
  "wsl.onboarding.updatingIRISIn": "Päivitetään IRISa kohteessa {{distro}}...",
  "wsl.onboarding.updateIRISIn": "Päivitä IRIS jakelussa {{distro}}.",
  "wsl.onboarding.updateIRIS": "Päivitä IRIS",
  "wsl.onboarding.opencodeReadyIn": "IRIS on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "IRIS on valmis.",
  "wsl.onboarding.installIRISIn": "Asenna IRIS jakeluun {{distro}}.",
  "wsl.onboarding.installIRIS": "Asenna IRIS",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "IRISa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin IRIS voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "IRIS ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten IRIS uudelleen.",
  ...
  "toast.update.description": "IRISn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä IRIS-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että IRIS ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "IRIS sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita IRIS-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda IRISn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä IRIS näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö IRIS järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta IRISn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun IRIS käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät IRISn uusinta versiota.",
  ...
  "desktop.menu.documentation": "IRIS-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "IRIS-valikko",
  ...
  "desktop.recovery.loadFailed": "IRISn lataaminen epäonnistui",
  "desktop.recovery.terminated": "IRIS-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "IRIS ei vastaa",
  ...
  "desktop.wsl.error.installIRIS": "IRISn asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "IRISa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "IRISn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "IRIS Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
